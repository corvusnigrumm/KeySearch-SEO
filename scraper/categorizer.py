...
_TAXONOMY: list[dict] = [
    {
        ...
        "subcategorias": [
            ...
            (
                ...
                ["adiestramiento", "entrenamiento perro", "obediencia", "agresividad", "ansiedad perro", "fobia"],
            ),
            (
                "Otras mascotas",
                ["hamster", "conejo", "pajaro", "loro", "pez", "tortuga", "iguana", "reptil", "acuario", "pecera"],
            ),
        ],
    },
    {
        ...
        "subcategorias": [
            ...
            (
                "Bienestar y Fitness",
                ["yoga", "meditacion", "ejercicio", "fitness", "bienestar", "relajacion", "mindfulness", "respiracion"],
            ),
            (
    ...
    },
    {
        ...
        "subcategorias": [
            ...
            (
                ...
                ["limpieza", "orden", "organizacion", "desinfectar", "limpiar", "productos de limpieza", "konmari"],
            ),
            (
                "Familia y Crianza",
                ["familia", "pareja", "matrimonio", "hijos", "crianza", "educacion hijos", "divorcio", "convivencia"],
            ),
            (
                "Jardín y Plantas",
                ["jardin", "planta", "terraza", "balcon", "jardineria", "semilla", "riego", "fertilizante", "poda"],
            ),
            (
                "Electrodomésticos y Reparaciones",
                ["electrodomestico", "lavadora", "nevera", "reparacion", "plomeria", "electricidad"],
            ),
        ],
    },
    {
        ...
        "subcategorias": [
            ...
            (
                ...
                ["restaurante", "chef", "gastronomia", "cocina gourmet", "maridaje", "cata", "critica gastronomica"],
            ),
            (
                "Bebidas",
                [
            ...
            (
                ...
                ["vegano", "vegetariano", "sin gluten", "lactosa", "organico", "natural", "keto", "paleo", "ayuno"],
            ),
            (
                "Panadería y Repostería",
                ["pan", "pastel", "torta", "galleta", "muffin", "reposteria", "panaderia", "dulce", "postre"],
            ),
        ],
    },
    {
        ...
        "subcategorias": [
            ...
            (
                ...
                ["pasaporte", "visa", "documentos viaje", "tramite viaje", "seguro de viaje", "requisitos entrada"],
            ),
            (
                "Presupuesto y Consejos",
                ["viaje barato", "presupuesto viaje", "ahorrar viaje", "mochilero", "tips viaje", "consejos viajero"],
            ),
        ],
    },
    {
        ...
        "subcategorias": [
            ...
            (
                "Running y Atletismo",
                ["running", "correr", "maraton", "atletismo", "trail", "carrera popular", "entrenamiento corredor"],
            ),
            ("Deportes de Agua", ["natacion", "surf", "buceo", "kayak", "remo", "polo acuatico", "snorkel", "vela"]),
            (
                "Deportes de Combate",
                ["boxeo", "artes marciales", "ufc", "judo", "karate", "taekwondo", "muay thai", "wrestling"],
            ),
            (
                "Motor y Aventura",
                [
    ...
    },
    {
        ...
        "subcategorias": [
            ...
            (
                ...
                ["fragancia", "perfume", "colonia", "uñas", "manicura", "pedicura", "joyeria", "bolso"],
            ),
        ],
    },
    {
        ...
        "subcategorias": [
            ...
            (
                "Libros y Literatura",
                ["libro", "novela", "autor", "editorial", "bestseller", "leer", "lectura", "manga", "comic", "saga"],
            ),
            (
                "Anime y Manga",
                ["anime", "manga", "otaku", "shonen", "seinen", "cosplay", "personaje anime", "temporada anime"],
            ),
            ("Podcasts y Radio", ["podcast", "radio", "locutor", "episodio", "escuchar", "programa", "entrevista"]),
        ],
    },
    {
        ...
        "subcategorias": [
            (
                "Inmigración y Visas",
                ["visa", "migracion", "inmigracion", "residencia", "nacionalidad", "ciudadania", "permiso de trabajo"],
            ),
            (
                "Trámites Civiles",
                [
            ...
            (
                "Derecho Familiar",
                ["divorcio", "custodia", "pension alimenticia", "herencia", "testamento", "matrimonio", "adopcion"],
            ),
            (
                "Impuestos y Fiscal",
                ["impuesto", "declaracion", "dian", "hacienda", "sat", "iva", "renta", "tributario", "multa fiscal"],
            ),
            (
                "Asesoría Legal",
                ["abogado", "ley", "derechos", "contrato", "demanda", "accion legal", "representacion legal", "bufete"],
            ),
        ],
    },
    {
        ...
        "subcategorias": [
            ...
            (
                ...
                ["inversion inmobiliaria", "finca raiz", "real estate", "rentabilidad", "plusvalia", "valorizar"],
            ),
            (
                "Construcción y Reformas",
                ["construir", "reforma", "remodelacion", "constructor", "arquitecto", "ingenieria civil", "materiales"],
            ),
        ],
    },
]
...
def _puntuar(keyword_norm: str, palabras_clave: list[str]) -> float:
    ...
    for pk in palabras_clave:
        ...
        if pk_norm == keyword_norm:
            ...
            if re.search(pattern, keyword_norm) or re.search(r"\b" + re.escape(keyword_norm) + r"(s|es)?\b", pk_norm):
                hits += 1
    return hits
